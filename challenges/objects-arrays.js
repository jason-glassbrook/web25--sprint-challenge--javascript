...
/*******************
  Request 1
  ----------------
  Create a new array called universities that contains all the universities in the graduates array. This will be an array of strings.
...
/*******************
  Request 2
  ----------------
  Create a new array called contactInfo that contains both first name and email of each student. This will be an array of strings.
...
const populationTotal = zooAnimals.reduce (
  (init , elem) => (init + elem.population)
, 0);
...
/*******************
  STRETCH
  ----------------
  If you haven't already, convert your array method callbacks into arrow functions.
*******************/
